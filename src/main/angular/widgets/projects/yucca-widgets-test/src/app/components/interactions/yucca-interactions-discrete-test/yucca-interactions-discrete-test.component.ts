...
@Component({
  selector: 'app-yucca-interactions-discrete-test',
  template: `
  <div class='container'>
    <div>
      <h1> Dataset Discrete Table</h1>
      <yucca-discrete-table datasetcode='{{datasetcode}}' 
        [groupByColumn]='groupByColumn' [serieColumns]='serieColumns' usertoken='{{usertoken}}'
        [numberFormat]='numberFormat'></yucca-discrete-table>
    </div>
    <div>
      ...
      [groupByColumn]='groupByColumn' [serieColumns]='serieColumns' usertoken='{{usertoken}}'
      [colors]='chartColors' 
      [numberFormat]='numberFormat'></yucca-discretebar-chart>
    </div>
  </div>
...
export class YuccaInteractionsDiscreteTestComponent implements OnInit {
