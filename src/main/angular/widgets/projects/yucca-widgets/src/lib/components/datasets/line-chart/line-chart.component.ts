...
@Component({
  selector: 'yucca-line-chart',
  templateUrl: './line-chart.component.html',
  styleUrls: ['./line-chart.component.css']
})
export class LineChartComponent extends BaseDatasetWidgetAxisC3Component implements OnInit {
  ...
  @Input() public xAxisAttr: any;
  @Input() public yAxisAttr: any;
  ...
  constructor(protected dataService: DataService, protected metadataService: MetadataService, protected prepareDataService: PrepareDataService,
    private cdr: ChangeDetectorRef, protected safeNumberPipe: SafeNumberPipe, protected broadcastService: BroadcastService) {
    super(dataService, metadataService, prepareDataService, safeNumberPipe, broadcastService);
    this.widgetType = "YuccaLineChart";
    console.debug("Constructor Line-chart-component");
  ...
  protected prepareData(): void {
    ...
    console.debug("linebar chartData---DEBUG", this.chartData);
      ...
      color: {
        ...
        format: {
          value: function (value, ratio, id) {
            return safeNumberPipe.transform(value, numberFormat);
          }
        }
      }
    }
  ...
  downloadData() {
    console.debug("downloadData", this.chartOptions);
